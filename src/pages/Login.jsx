...
export default function Login() {
  const { register, handleSubmit, errors, loading } = useAuth(false);

  return (
    <>
      <title>Login - Event Management</title>
      <meta name="description" content="Login to your Event Management account to manage your events and bookings." />
        ...
        <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%] dark:bg-zinc-900">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col items-center justify-center gap-4 w-[80%] md:w-[60%] mx-auto">
            ...
            <p className="text-[14px] text-gray-400">
              Do not have an account? <Link to='/sign-up' className="text-blue-400 ml-1">Create one</Link>
            </p>
            <Button
              type="submit"
              variant="default"
